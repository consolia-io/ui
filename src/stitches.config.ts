...
const defaultTheme = {
  colors: {
    ...
    blue: "#8fbdd8",
    blueLight: "#ddebf3",
    border: "rgba(150, 120, 180, 0.15)",
    borderLight: "rgba(150, 120, 180, 0.1)",
    orange: "#ecb489",
    orangeLight: "#fae1ce",
    overlay: "rgba(15, 8, 18, 0.2)",
    purple: "#a79bd0",
    purpleLight: "#E4E1F1",
    surface: "rgba(150, 120, 180, 0.08)",
    surfaceHover: "rgba(150, 120, 180, 0.12)",
    surfaceLight: "rgba(150, 120, 180, 0.05)",
    text: "rgb(23, 14, 31)",
    yellow: "rgb(255, 211, 122)",
    yellowLight: "#fff3d8",
  },
  fonts: {
